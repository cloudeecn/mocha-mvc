...
import works.cirno.mocha.mvc.resolver.prd.LongTreePrefixDict;
import works.cirno.mocha.mvc.resolver.prd.PrefixDict;
...
public class PrefixDictInvokeTargetResolver implements InvokeTargetResolver {
	...
	private PrefixDict<PrefixedInvokeTargetCriteria> dict = new LongTreePrefixDict<>();
